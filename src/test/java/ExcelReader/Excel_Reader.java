...
public class Excel_Reader {
	...
	public static void main(String[] args) {
		String path = System.getProperty("user.dir") + "//src//test//resources//TestData//DataEngine.xlsx";
		...
		System.out.println(obj.getColumnCount("TesDdata"));
		
		System.out.println(obj.getCellData("TestData", 1, 3));
	}
}