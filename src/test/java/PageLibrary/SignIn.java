...
public class SignIn extends TestBase{
	...
	public void loginToApplication(){
		log.info("login in to Application");
		clickonSignIn();
	...
	public void loginToApplication(String Email, String Password){
		log.info("Login in to application using given:-->"+Email+ " and givem password :--->"  +Password);
		clickonSignIn();
	...
	public void logout(){
		log.info("user is getting log out from the application");
		try{
